...
From the plot, we can see that the distribtion of residuals is not good, and violate our assumption of regression.A way to improve could be clean the data, I think there are some NA could be biased for the regresssion.
```{r}
