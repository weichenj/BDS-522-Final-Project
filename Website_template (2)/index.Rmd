...
Sex, Sleeptime, income level and eudcational level, and BMI
There will be more data been selected in question 3, to see more detailed description, see question 2 and question 3

```{r cars}
summary(brfss2013$sex)
# We have more female than male, 290455 vs 201313.
...
#This varible palys important role in this project.
